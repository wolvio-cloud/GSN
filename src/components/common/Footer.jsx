    ...
    <footer className="bg-[#1A1A1A] text-white py-12 px-6 md:px-16 lg:px-24">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <ul className="space-y-2 text-[14px] font-ubuntu">
            <li className="hover:text-gray-400 cursor-pointer">GSN Experience</li>
            <li className="hover:text-gray-400 cursor-pointer">Global Community</li>
            <li className="hover:text-gray-400 cursor-pointer">GSN Franchising</li>
            <li className="hover:text-gray-400 cursor-pointer">Blogs & Insights</li>
          </ul>
        </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-end max-w-7xl mx-auto   mt-12 gap-6">
        ...
        <div className="flex items-center gap-6 justify-center">
          <a href="https://www.instagram.com/gsn_network?igsh=eTd5cXd5NDNnZms=" target="_blank" rel="noopener noreferrer">
            <FaInstagram className="text-[28px] hover:text-gray-400 cursor-pointer" />
          </a>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-center">
        ...
        <div className="text-[14px] font-ubuntu font-bold text-center">
          © 2025 <span className="font-bold">GSN</span>, all rights reserved. A group of Zenith77 Multi Business Pvt Ltd.
        </div>
      </div>
    </footer>
  );
