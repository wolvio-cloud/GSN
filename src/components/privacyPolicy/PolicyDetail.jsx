  ...
  return (
   <section
    ...
    >
      ...
      <div className="bg-[#d2dce4] h-[40px] md:h-[70px] w-full rounded-full"></div>
      ...
      <div className="max-w-[1694px] mx-auto relative">
        ...
        <div className="flex flex-col lg:flex-row gap-10 mt-8">
         ...
         <div className="flex-1 ">
            {/* Intro Paragraph */}
            <p
              className="font-ubuntu  font-medium text-[18px] md:text-[21px] leading-[1.4] text-center mb-12 max-w-[900px] mx-auto "
            >
            ...
            {/* Section 1 */}
            <h2 className="font-ubuntu font-bold text-[24px] mt-25 mb-3">
              1. Introduction
            </h2>
            <p className="font-ubuntu text-[20px] leading-[1.6] mb-6">
            ...
            <p className="font-ubuntu text-[20px] leading-[1.6] mb-4">
              We collect and process personal data through the following
              channels:
            </p>

            {/* 3a */}
            <h3 className="font-ubuntu font-bold text-[20px] mb-2">
              a) Data You Provide to Us Directly
            </h3>
            <ul className="list-disc ml-6 mb-4 font-ubuntu text-[20px] leading-[1.6]">
              <li>Full name</li>
              <li>Email address</li>
            ...
            <p className="font-ubuntu text-[20px] mb-4">
...
<div className="lg:w-[445px] flex-shrink-0 mt-4 lg:mt-50">
    ...
    <div className="sticky lg:top-[100px] top-[10px] bg-[#d2dce4] rounded-[20px] p-6">
      <h3 className="font-ubuntu font-medium text-[20px] md:text-[22px] text-black mb-4 text-center">
        LEGAL PAGES
      </h3>
