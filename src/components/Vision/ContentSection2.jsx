...
//             <div className="bg-[#D2DCE4] rounded-3xl p-15 sm:p-8 h-full mt-6 md:mt-10 md:ml-6 lg:ml-10">
...
//           {/* Right Column */}
//           <div className="flex flex-col justify-start space-y-8 h-full">
//             <div className="bg-[#D2DCE4] rounded-3xl p-15 sm:p-8 h-full md:mr-6 lg:mr-8">
    ...
    <section className="py-16 px-6 md:px-16 lg:px-24 w-full bg-white">
      <div className="mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-3 gap-8 items-center">
          {/* Row 1 (Reversed: Card1 left, Text right) */}
          ...
          {/* Row 2 (Vertical line under Card1) */}
