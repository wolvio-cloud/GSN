    ...
    <section className="bg-white py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="flex flex-col justify-start space-y-8 h-full order-2 lg:order-1">
            <div className="bg-[#D2DCE4] rounded-3xl p-6 sm:p-8 h-full md:mr-6 lg:mr-8">
          ...
          <div className="hidden lg:flex flex-col items-center relative order-2">
            ...
            <div className="absolute left-0 top-1/2 -translate-y-1/2 -ml-65 flex flex-col items-center">
              <div className="w-2 h-2 rounded-full border-2 border-gray-300 bg-transparent mb-0"></div>
              <div className="w-[2px] h-[15px] bg-gray-300"></div>
              <div className="w-2 h-2 rounded-full border-2 border-gray-300 bg-transparent mt-0"></div>
            </div>

            {/* Horizontal Line */}
            <div className="w-[470px] h-[2px] bg-gray-300 relative mt-[400px]">
          ...
          <div className="flex flex-col justify-start space-y-8 h-full order-1 lg:order-3">
            <div className="md:ml-6 lg:ml-15">
              <h1 className="text-2xl sm:text-2xl font-bold text-[#153153] leading-tight">
                Growth With Purpose
              </h1>
