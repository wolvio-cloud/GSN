    ...
    <section className="bg-white py-16 px-4 sm:px-8 lg:px-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-8">
          {/* Asia Pacific */}
          <div className="bg-[#D2DCE4] rounded-xl p-6 md:p-5.5 w-full">
            <h3 className="text-[#153153] font-bold font-ubuntu text-[28px] md:text-[28px] lg:text-[25px] mb-4">
              ASIA PACIFIC
            </h3>
            <p className="text-[#153153] font-ubuntu text-[18px] md:text-[18px] lg:text-[18px] leading-relaxed">
          ...
          {/* Latin America */}
          <div className="bg-[#D2DCE4] rounded-xl p-6 md:p-3 w-full">
            <h3 className="text-[#153153] font-bold font-ubuntu text-[28px] md:text-[28px] lg:text-[25px] mb-4">
              LATIN AMERICA
            </h3>
            <p className="text-[#153153] font-ubuntu text-[18px] md:text-[18px] lg:text-[18px] leading-relaxed">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-[#D2DCE4] rounded-xl p-6 md:p-5 w-full">
            ...
            <p className="text-[#153153] font-ubuntu text-[18px] md:text-[22px] lg:text-[18px] leading-relaxed">
          ...
          {/* North America */}
          <div className="bg-[#D2DCE4] rounded-xl p-6 md:p-4 w-full">
            <h3 className="text-[#153153] font-bold font-ubuntu text-[28px] md:text-[32px] lg:text-[25px] mb-4">
              NORTH AMERICA
            </h3>
            <p className="text-[#153153] font-ubuntu text-[18px] md:text-[22px] lg:text-[18px] leading-relaxed">
        ...
        {/* Right Column */}
        <div className="bg-[#D2DCE4] rounded-xl p-6 md:p-6 w-full h-fit">
          <h3 className="text-[#153153] font-bold font-ubuntu text-[28px] md:text-[32px] lg:text-[25px] mb-4">
            MIDDLE EAST & AFRICA
          </h3>
          <p className="text-[#153153] font-ubuntu text-[18px] md:text-[22px] lg:text-[18px] leading-relaxed">
